import 'package:connectit/models/sns_ids.dart';
...
List<PostIt> postItsTester = [
  ...
  PostIt.initialize(
    ...
    topics: ['Computer Science', 'Junior'],
    snsIds: SnsIds.initialize(
      instagram: 'instagram_id_4',
      facebook: 'facebook_id_4',
      kakaotalk: 'kakaotalk_id_4',
    ),
  ),
  PostIt.initialize(
    ...
    topics: ['Computer Science', 'Junior'],
    snsIds: SnsIds.initialize(
      instagram: 'instagram_id_5',
      facebook: 'facebook_id_5',
      kakaotalk: 'kakaotalk_id_5',
    ),
  ),
];